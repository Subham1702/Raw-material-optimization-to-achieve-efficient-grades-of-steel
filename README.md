...
## Data Understanding:
1) Data Dimension = 311 records, 27 attributes.
2) Data Dictionary:
...
import pandas as pd
raw_data = pd.read_csv(r"C:\Users\mital\Documents\Project-3 (Optimization of raw materials to achieve efficient grades of steel)\data.csv")
